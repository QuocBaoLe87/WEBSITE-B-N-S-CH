...
public class Book {
    ...
    @Column(name = "image1", columnDefinition = "VARBINARY(MAX)")
    private byte[] image1;

    @Lob
    @Basic(fetch = FetchType.LAZY)
    @Column(name = "image2", columnDefinition = "VARBINARY(MAX)")
    private byte[] image2;

    @Lob
    @Basic(fetch = FetchType.LAZY)
    @Column(name = "image3", columnDefinition = "VARBINARY(MAX)")
    private byte[] image3;

    @Lob
    @Basic(fetch = FetchType.LAZY)
    @Column(name = "image4", columnDefinition = "VARBINARY(MAX)")
    private byte[] image4;

    @Lob
    @Basic(fetch = FetchType.LAZY)
    @Column(name = "image5", columnDefinition = "VARBINARY(MAX)")
    private byte[] image5;
