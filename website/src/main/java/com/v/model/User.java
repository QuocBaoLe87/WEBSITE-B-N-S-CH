...
public class User {
  ...
  // Không dùng @NotBlank ở đây để tránh lỗi khi chỉnh sửa (form không gửi
  // password).
  // Luồng kiểm tra bắt buộc mật khẩu khi tạo mới đã được xử lý ở
  ...
  protected void normalize() {
    ...
    if (role == null || role.trim().isEmpty()) {
      ...
      // Normalize role: đảm bảo format "ROLE_XXX"
