...
public class GmailService {
    ...
    @Value("${app.mail.from-name:ZUNO Library}")
    ...
    public void sendOrderConfirmationEmail(Order order) {
        ...
        try {
            ...
            log.warn("[Mail] Không thể nạp lại order với items: {} (vẫn tiếp tục với đối tượng hiện có)",
                    e.getMessage());
        }
        ...
        try {
            ...
            helper.setSubject("[ZUNO Library] Xác nhận đơn hàng #" + order.getId());
